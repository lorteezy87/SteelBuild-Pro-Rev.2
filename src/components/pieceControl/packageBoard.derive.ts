...
/** Satisfies LeafSelectablePiece so selectActionableLeafPieces keeps BoardPiece. */
export interface BoardPiece extends LeafSelectablePiece {
  piece_mark: string;
  lot_code: string;
...
export interface BoardWorkPackage {
  ...
  name?: string | null;
  /** Matches ReadinessWorkPackage / snapshot nullability under strictNullChecks. */
