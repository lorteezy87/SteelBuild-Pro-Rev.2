...
import { X, Search, ExternalLink, Trash2, FilePlus, Sparkles, Check, Link2, ArrowRight, ArrowDown } from "lucide-react";
...
import {
  ...
  formatRelative,
  describeActivity,
} from "./zonePanel/zonePanelHelpers";
...
function ReadinessRing({ pct, label, drivers = [], dragInfo = null }) {
  const SIZE = 56;
  const STROKE = 6;
...
function OverviewTab({ zone, items, counts, computed, readiness, dependencyImpact, onApplyComputed }) {
