          ...
          {(step === "preview" || step === "committing") && staged && (
            <div style={{ display: "flex", flexDirection: "column", gap: 14 }}>
              <div style={{ display: "flex", flexWrap: "wrap", gap: 8 }}>
                <ImportStatChip label="New sheets" value={staged.stats.create} tone="var(--status-success)" />
                <ImportStatChip label="Enrich existing" value={staged.stats.update} tone={ACCENT} />
                <ImportStatChip label="Skipped" value={skipped.length} tone="var(--text-muted)" />
              </div>
