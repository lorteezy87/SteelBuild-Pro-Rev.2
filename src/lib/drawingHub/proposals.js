/**
 * drawingHub/proposals.js — Analyzer→Zones bridge (V3.0).
 *
 * Extracted from src/lib/drawingHub.js. Behavior + Supabase calls are
 * byte-identical to the original.
 *
 * AI analysis emits drawing_findings; this module clusters them into
 * drawing_zone_proposals and drives the accept / reject / merge
 * workflow that turns proposals into real drawing_zone rows.
 */

import { supabase } from "@/lib/supabase";
import { ZONE_TYPES } from "./constants";
import { ensureCurrentRevision } from "./revisions";
