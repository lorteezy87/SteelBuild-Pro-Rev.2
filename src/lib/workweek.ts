...
function isWorkday(date: Date, workDaysPerWeek: number = WORKDAYS_PER_WEEK): boolean {
 ...
 */
export function addWorkdays(start: DateLike, n: number, workDaysPerWeek: number = WORKDAYS_PER_WEEK): Date {
 ...
 */
export function workdaysBetween(start: DateLike, end: DateLike, workDaysPerWeek: number = WORKDAYS_PER_WEEK): number {
 ...
 */
export function hoursToWorkdays(hours: unknown, hoursPerDay: number = HOURS_PER_WORKDAY): number {
 ...
 */
export function workdaysToCalendarDays(workdays: unknown, workDaysPerWeek: number = WORKDAYS_PER_WEEK): number {
