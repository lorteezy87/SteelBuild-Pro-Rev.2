...
import {
  RFI_CSV_COLUMN_ALIASES as COLUMN_ALIASES,
  RFI_CSV_JOB_NUMBER_ALIASES as JOB_NUMBER_ALIASES,
  RFI_CSV_MONTHS as MONTHS,
} from "./importRfiCsvHelpers";
...
// ── Column aliases ──────────────────────────────────────────────────
//
// Catalogs live in importRfiCsvHelpers.ts (COLUMN_ALIASES / JOB_NUMBER_ALIASES
// / MONTHS imported at top). Match is case-insensitive, trimmed, and ignores
// punctuation — so "RFI #", "rfi_number", and "RFI Number" all resolve to the
// same slot.
...
// MONTHS catalog is imported from importRfiCsvHelpers.
