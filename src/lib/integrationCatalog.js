export const INTEGRATION_AREAS = [
  ...
  },
  {
    ...
    status: "Partially Live",
    risk: "Medium",
    shortDescription: "Bluebeam Max API integration — create sessions, push documents, manage markups, and sync review status with SteelBuild.",
    systems: ["Bluebeam Max", "Bluebeam Revu", "Generic PDF", "PlanGrid exports"],
    existingCapabilities: [
      "Bluebeam Max API integration with OAuth2 connection, session management, and document push.",
      ...
      "Per-project Bluebeam session tracking linked to drawing sets and submittals.",
    ],
    targetWorkflows: [
      "Create Bluebeam Max sessions from drawing sets or submittals.",
      "Push PDFs to sessions for collaborative markup review.",
      "Invite project team members to review sessions.",
      "Pull markup snapshots back to SteelBuild documents.",
      "Bluebeam CSV/PDF import review queue.",
      "Revision comparison handoff back to drawings and RFIs.",
    ],
    dataTouched: ["Drawings", "Drawing Sets", "RFIs", "Documents", "Markup", "Submittals"],
    prerequisites: ["Bluebeam Studio Prime subscription", "Developer portal app registration", "OAuth2 redirect URI", "Session permission model"],
    nextSprint: [
      "Register Bluebeam developer app at developers.bluebeam.com and configure secrets.",
      "Connect Bluebeam account on the Integrations page.",
      "Push drawing set PDFs to Bluebeam sessions from the Drawings page.",
      "Webhook subscription for real-time session and markup events.",
    ],
  },
  {
    key: "scheduling",
