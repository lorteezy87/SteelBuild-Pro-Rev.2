...
import {
  ...
  BULK_FOLDER_HEADER_STYLE,
  BULK_FOLDER_BODY_STYLE,
  BULK_FOLDER_FOOTER_STYLE,
  bulkFolderBtnStyle,
} from "./bulkCreateFoldersModalHelpers";

// Re-export for any callers that imported from this modal file.
export { parseBulkFolderInput } from "./documentsPageHelpers";

const overlay = BULK_FOLDER_OVERLAY_STYLE;
const dialog = BULK_FOLDER_DIALOG_STYLE;
const header = BULK_FOLDER_HEADER_STYLE;
const body = BULK_FOLDER_BODY_STYLE;
const footer = BULK_FOLDER_FOOTER_STYLE;
const btn = bulkFolderBtnStyle;
