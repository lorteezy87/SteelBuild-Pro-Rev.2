// @ts-nocheck — presentational extract; styles are runtime CSS objects
/**
 * Presentational panels for Contract Management.
 * Extracted from ContractManagement.jsx (behavior-preserving).
 */
...
// ─── Progress bar ───────────────────────────────────────────────────────────
export const ProgressBar = ({ value, height = 6 }) => {
...
export function ContractOverviewPanel({ project, approvedCOTotal, pendingCOTotal, revisedValue, editingContract, contractForm, setContractForm, onEditContract, onSaveContract, onCancelContract, isSaving }) {
