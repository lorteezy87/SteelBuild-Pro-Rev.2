...
export const PRIMARY_TABS = [
  ...
  { label: "DRAWINGS",    pages: ["DrawingSubmittalHub", "Drawings", "Submittals", "DrawingAnalysis", "DrawingViewer", "PdfImportReview", "Documents", "ModelViewer", "ModelRegistry"] },
...
export const ALL_MODULES = [
  ...
  { icon: "\u25A8", name: "Model Registry",           group: "Detailing",     page: "ModelRegistry" },
  ...
  { icon: "\u2709", name: "Email Intake",             group: "Comms",         page: "EmailIntake" },
...
export const NAV_GROUPS = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: "PDF Import Queue",      icon: "\u25A4", page: "PdfImportReview" },
      { label: "Document Repository",   icon: "\uD83D\uDCC1", page: "Documents" },
      { label: "3D Model Viewer",       icon: "\u25B3", page: "ModelViewer" },
      { label: "Model Registry",        icon: "\u25A8", page: "ModelRegistry" },
    ],
  },
  {
...
export const SIDEBAR_GROUPS = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: "Mitigations",    icon: "\u2696", page: "Mitigations" },
      { label: "Meetings",       icon: "\uD83D\uDC65", page: "Meetings" },
      { label: "Email Intake",   icon: "\u2709", page: "EmailIntake" },
    ],
  },
  {
