...
const ROUTE_DOMAINS = {
  ...
  communications: {
    ...
    EmailIntake:      r(lazyWithRetry(() => import("@/pages/EmailIntake")),      "Email Intake",        { projectScoped: true }),
  },
  ...
  documents: {
    ...
    PdfImportReview:  r(lazyWithRetry(() => import("@/pages/PdfImportReview")),  "PDF Import Review",   { projectScoped: true }),
    ...
    ModelRegistry:    r(lazyWithRetry(() => import("@/pages/ModelRegistry")),    "Model Registry",      { projectScoped: true }),
