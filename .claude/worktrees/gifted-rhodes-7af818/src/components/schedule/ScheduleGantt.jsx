...
export default function ScheduleGantt({ tasks: rawTasks = [], submittals = [], deliveries = [], weatherRisk = null, onTaskClick, onSave, phaseFilter = "all", externalFocus = null }) {
  ...
  // Count how many tasks have baseline data so the toggle only renders when
  // there's something to show. Also compute which tasks have drifted from
  // their baseline for rendering ghost bars.
