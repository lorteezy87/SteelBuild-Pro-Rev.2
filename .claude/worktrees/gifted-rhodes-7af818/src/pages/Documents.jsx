...
import ExternalFolderBrowser from "@/components/integrations/ExternalFolderBrowser";
...
export default function Documents() {
  ...
  const [externalStorageOpen, setExternalStorageOpen] = useState(false);
  ...
  return (
    ...
    >
      ...
      <Toolbar
        ...
        onExternalStorageOpen={() => setExternalStorageOpen(true)}
      />
      ...
      {externalStorageOpen && (
        <ExternalFolderBrowser onClose={() => setExternalStorageOpen(false)} />
      )}
