...
**2026-07-26 (draft):** ActionItems page-shell `LoadingSkeleton` + error/retry gates (ID **18** residual) — ControlCenter does not take `isLoading`; peer RFIs/COs/Backcharges pattern.
