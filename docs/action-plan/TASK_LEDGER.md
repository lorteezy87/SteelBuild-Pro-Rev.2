...
| 18 | Done | Photos/Safety + thin CRUD RegisterFetchBody (#133/#137); EmailAccount/Review/Transmittal skeletons on email-review slice; not universal | `WORK_NEXT_SLICE.md` |
...
| 48 | Partial | EmailAccount/ReviewQueue/TransmittalLog toast helpers + prior #133–#137; #139/#140 open; not universal | `WORK_NEXT_SLICE.md` |
| 49 | Completed | `invalidateAfterMutation` helper | same + cacheRegistry |
| 50 | Partial | EmailAccount/DrawingReview/DrawingTransmittal(+Item) create fail-closed; prior page/modal/import wiring; #139/#140 open | `WORK_NEXT_SLICE.md` |
