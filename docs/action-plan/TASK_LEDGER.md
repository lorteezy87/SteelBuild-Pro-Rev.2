...
| 48 | Partial | DMS Upload/Edit/LinkedFolder/Detail toasts + prior #133–#137 stack; DocumentStorageSettings deferred; not universal | `WORK_NEXT_SLICE.md` |
| 49 | Completed | `invalidateAfterMutation` helper | same + cacheRegistry |
| 50 | Partial | DMS Document.create (Upload + LinkedFolder import) + DocumentEdit stamp; prior page/modal/import wiring; DocumentStorageSettings LinkedFolder create + org-level remain | `WORK_NEXT_SLICE.md` |
