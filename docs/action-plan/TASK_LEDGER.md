...
| 18 | Done | Photos/Safety INLINE + thin CRUD RegisterFetchBody (#133/#137); Contacts RegisterFetchBody on contacts-dms slice; not universal | `WORK_NEXT_SLICE.md` |
...
| 48 | Partial | Contacts/Vendors/DocumentStorageSettings toast helpers + prior #133–#137 stack; #139 DMS toasts open; not universal | `WORK_NEXT_SLICE.md` |
| 49 | Completed | `invalidateAfterMutation` helper | same + cacheRegistry |
| 50 | Partial | Contact.create + LinkedFolder.create fail-closed; prior page/modal/import wiring; #139 DMS Document.create open; Vendor remains org-level | `WORK_NEXT_SLICE.md` |
