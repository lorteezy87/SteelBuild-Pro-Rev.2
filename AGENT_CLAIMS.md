...
|---|---|---|---|---|
| 2026-09-21 | codex-claude-pending-issues | Reconcile three Claude handoffs | drawing register/viewer, RFI vocabulary, exports, comments/project reads, related tests and handoff docs | Verify pending PR fixes on current main, resolve overlap, close remaining reproducible bugs in an isolated branch. |
