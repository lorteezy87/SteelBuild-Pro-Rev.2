...
|---|---|---|---|---|
| 2026-08-24T00:48:29Z | codex-rfi-detail-queries | Separate RFI navigation and Detail Queries register | src/config/{moduleRegistry,pageIcons,routes}*; src/pages/{RFIs,DetailQueries}*; src/pages/rfis/**; related tests | Add a dedicated RFIs navigation section containing RFI Register and Detail Queries; reuse the RFI lifecycle while separating records through metadata. |
| 2026-08-13T19:25:00Z | grok-notes-folders-job-linking | Production Notes folders + multi-job linking | src/pages/ProductionNotes.jsx; src/lib/noteFolders/**; src/components/productionnotes/**; src/services/{permissions,cacheRegistry}.ts; supabase/migrations/20260813120000_note_folders_job_linking.sql; supabase/migrations/__tests__/noteFoldersJobLinking.test.ts; supabase/functions/project-export/index.ts | Add org-scoped note folders with inherited/independent job links, every-job access rule, General Notes migration, and PM/admin linking UI. |
...
| 2026-08-10T02:39:31Z | codex-piece-intelligence-command | Canonical Piece Intelligence integration (donor: codex/piece-intelligence-command-center) + integration route availability | docs/superpowers/{specs,plans}/2026-08-09-piece-intelligence*; src/pages/PieceRegister.tsx; src/pages/pieceRegister/**; src/components/pieceControl/**; src/lib/pieceControl/**; src/pages/dashboardCC/DashboardControlCenter.tsx; src/pages/Dashboard.jsx; src/__tests__/pieceRegisterWiring.test.ts; src/styles/piece-control-command.css; src/config/{moduleGating,moduleRegistry}.js; src/config/__tests__/{moduleGating,launcherConfig}.test.js; src/pages/__tests__/{Integrations,EmailInbox}*; supabase/migrations/*piece_intelligence*; related migration tests | Canonical Piece Intelligence integration owner; also enforce PM impact writes, ungate the existing Integrations and Email Inbox routes, render Email Inbox in desktop/mobile launchers, keep Data Exchange staged, and complete UI/dashboard verification. |
| 2026-08-10T02:44:27Z | codex-piece-intelligence | Piece Intelligence Command Center | docs/superpowers/{specs,plans}/2026-08-09-piece-intelligence*; src/pages/PieceRegister.tsx; src/components/pieceControl/{PieceRegisterOverview,PieceRevisionImpactView,PieceDigitalThread,PieceControlDashboardPanel}*; src/lib/pieceControl/{pieceIntelligence*,queryKeys}*; src/styles/piece-control-command.css; related tests | Integrate revision exposure, Changes & Risks overview, Piece Digital Thread, deep links, shared dashboard summary, and verification without migrations. |
