...
|---|---|---|---|---|
| 2026-07-27T22:45:00Z | cursor-piece-sort-bulk-update-d3a1 | Piece register sort by WP + bulk update | src/lib/pieceControl/{pieceRegisterSort,bulkUpdatePieces}.ts, src/components/pieceControl/PieceRegisterBulkBar.tsx, src/components/pieceControl/PieceRelationshipManager.tsx (sort only), src/pages/PieceRegister.tsx (minimal wire), supabase/migrations/*bulk_update_piece* | Sort register/lots by work package; bulk WP/hold/sequence/area update via existing + new RPC |
