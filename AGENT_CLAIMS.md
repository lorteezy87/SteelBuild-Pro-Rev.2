...
|---|---|---|---|---|
| 2026-08-10T02:39:31Z | codex-piece-intelligence-command | Piece Intelligence command center + revision exposure | docs/superpowers/{specs,plans}/2026-08-09-piece-intelligence*; src/pages/PieceRegister.tsx; src/pages/pieceRegister/**; src/components/pieceControl/**; src/lib/pieceControl/**; src/pages/dashboardCC/DashboardControlCenter.tsx; src/pages/Dashboard.jsx; src/__tests__/pieceRegisterWiring.test.ts; src/styles/piece-control-command.css; related tests | Extend the existing Piece Register with changes-and-risks overview, revision impact, piece digital thread, fab-gate integration, and dashboard deep links. |
