...
|---|---|---|---|---|
| 2026-09-12T22:45:00Z | drawings-route-decomposition | Drawings route decomposition | src/pages/Drawings.jsx; src/pages/drawings/**; focused Drawings route tests | Extract typed route derivations, query/mutation controller logic, and presentational page sections without changing drawing/set workflows or UX. |
