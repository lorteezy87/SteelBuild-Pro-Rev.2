...
|---|---|---|---|---|
| 2026-09-12T19:26:00Z | piece-control-containers | Piece Control container decomposition | src/components/pieceControl/{PieceRelationshipManager,PieceProductionControl,PieceLogisticsControl}*; src/components/pieceControl/__tests__/**; src/lib/pieceControl/** (minimal shared helpers only) | Extract typed pure derivations and safe board orchestration hooks while preserving queries, mutations, actionable-leaf rules, and UX. |
| 2026-08-24T00:00:00Z | codex-wp-dropdown-gantt-summary-overdue | Work-package drawing picker + Gantt summary overdue | docs/superpowers/plans/2026-08-24-wp-dropdown-gantt-summary-overdue.md; src/components/workpackages/{WPFormModal.jsx,__tests__/WPFormModal.test.jsx}; src/components/schedule/{ScheduleGantt.jsx,scheduleGanttHelpers.ts,__tests__/scheduleGanttHelpers.test.js} | Keep drawing-set options theme-readable on hover and exclude summary parents from overdue classification. |
