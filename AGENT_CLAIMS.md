...
|---|---|---|---|---|
| 2026-09-12T20:13:00Z | copilot-schedule-gantt-inline-edit | Schedule Gantt inline task editing | src/components/schedule/{ScheduleGantt.jsx,useGanttInlineEdit.ts,__tests__/useGanttInlineEdit.test.tsx} | Extract inline-edit state and save interaction into a typed, focused hook without behavior changes. |
