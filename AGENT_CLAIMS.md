...
|---|---|---|---|---|
| 2026-07-21T06:15:00Z | codex-logistics-query | Canonical logistics snapshot reads | src/lib/pieceControl/logisticsRepository.ts, src/lib/pieceControl/logisticsRepository.test.ts | Bound Piece Register logistics event queries so large canonical projects do not exceed PostgREST request limits. |
