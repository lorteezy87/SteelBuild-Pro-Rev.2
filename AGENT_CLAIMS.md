...
|---|---|---|---|---|
| 2026-07-27T22:15:00Z | cursor-piece-drawing-link-template-d3a1 | Piece↔drawing bulk link + unified CSV template | src/lib/pieceControl/{pieceRegisterCsvTemplate,importDrawingLink,bulkLinkDrawings,importAssign,importAdapters,repository}.ts, src/components/pieceControl/PieceRelationshipManager.tsx, src/pages/PieceRegister.tsx (import tab only) | Downloadable register CSV with wp_number/sheet_number; post-apply assign/link; bulk link selected pieces to one drawing |
