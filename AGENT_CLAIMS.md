...
|---|---|---|---|---|
| 2026-09-18T07:00:00Z | gpt-steelbuild-ui-phase1 | SteelBuild Pro UI redesign Waves 1–4 | src/styles/{tokens,command,piece-control-command}.css; src/components/{command,nav,workpackages}/**; src/config/moduleRegistry.js; src/pages/{dashboardCC,commandCenter,rfis,drawingSubmittalHub,submittals,workPackages,pieceRegister,fabRelease,productionStatus,procurement,deliveries,schedule,field,costHub,changeOrders,backcharges,sov,payApplications,portfolio,reportsHub,documents}/**; related route pages/tests; docs/superpowers/{specs,plans}/2026-09-1*-steelbuild-pro-ui-redesign* | Complete approved orange/steel dual-theme redesign through production, field, commercial, portfolio, reports, and documents without changing business logic, financial math, RLS, or release authority. |
