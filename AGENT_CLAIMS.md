...
|---|---|---|---|---|
| 2026-09-17T06:00:00Z | gpt-steelbuild-ui-phase1 | SteelBuild Pro UI redesign Waves 1–2 | src/styles/{tokens,command,piece-control-command}.css; src/components/{command,nav}/**; src/config/moduleRegistry.js; src/pages/{dashboardCC,commandCenter,rfis,drawingSubmittalHub,submittals,workPackages,pieceRegister,fabRelease}/**; src/pages/{RFIs.jsx,DrawingSubmittalHub.tsx,Submittals.tsx,WorkPackages.tsx,PieceRegister.tsx,FabRelease.tsx}; docs/superpowers/{specs,plans}/2026-09-1*-steelbuild-pro-ui-redesign*; related tests | Continue approved orange/steel dual-theme redesign through RFIs, Detailing/Submittals, Work Packages, Piece Register, and Fab Release without changing business logic or release authority. |
