...
|---|---|---|---|---|
| 2026-09-12T23:14:52Z | refactor-submittals-hooks | Submittals data hook decomposition | src/hooks/useSubmittals.ts; src/hooks/submittals/**; related focused tests | Split the oversized hook into typed query, mutation/payload, and focused-hook modules while preserving its public API and behavior. |
