...
|---|---|---|---|---|
| 2026-07-27T01:05:00Z | cursor-dead-code-lean-2696 | Dead-code lean-out | src/pages.config.js, src/components/{drawings/register,commandcenter,dashboard,actionitems,rfis,deliveries,dailylogs,productionnotes,dms,financials,schedule,gantt}/**, src/components/LocalLoginForm.jsx | Remove confirmed unused pages/components/shims after import-graph audit |
