...
|---|---|---|---|---|
| 2026-09-22 | codex-p0-deploy-environment-boundary | Production deployment credential boundary | .github/workflows/ci.yml; scripts/__tests__/deploymentEnvironmentBoundary.test.ts; docs/runbooks/cloudflare-migration.md | Require protected GitHub Environments for production, staging, and preview Cloudflare credentials; document the owner-side secret migration. |
