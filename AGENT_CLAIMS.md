...
|---|---|---|---|---|
| 2026-09-12T19:15:00Z | lorteezy87-code-refactoring-plan | Canonical Piece Control derivations | src/lib/pieceControl/{canonicalRollups,lifecycle,presentation}*; src/components/pieceControl/{PieceControlDashboardPanel,PieceAttentionPanel,PieceLifecycleStrip}*; related tests | Consolidate typed actionable-leaf lifecycle, exception, and summary derivations before thinning Piece Control containers. |
