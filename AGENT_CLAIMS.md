...
|---|---|---|---|---|
| 2026-07-27T01:20:00Z | cursor-project-archive-reappear-3d17 | Project archive reappears in dropdown | src/components/shared/ProjectContext.jsx, src/components/shared/SecureDeleteDialog.jsx, src/pages/Projects.jsx, src/__tests__/components/ProjectContext.test.jsx, supabase/migrations/20260727012111_archive_project_visibility.sql | Keep archived projects out of switcher: RLS is_deleted gate + stale ProjectContext reload race + await archive confirm. |
