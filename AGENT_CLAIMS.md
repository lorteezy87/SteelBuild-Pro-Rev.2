...
|---|---|---|---|---|
| 2026-07-21T06:15:00Z | codex-piece-read-contracts | Canonical Piece Register and dashboard reads | src/lib/pieceControl/{logisticsRepository,canonicalDashboardRepository}{,.test}.ts | Bound large logistics event queries and align the legacy production dashboard select with the real schema. |
