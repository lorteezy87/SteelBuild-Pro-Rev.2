...
|---|---|---|---|---|
| 2026-07-26T03:05:00Z | cursor-ap-import-doccontrol-d3a1 | Action-plan ID 50/48 import + Doc Control creates | src/components/{expenses/ExpenseImportModal,changeorders/ChangeOrderImportModal,drawings/register/ReviewQueuePanel,drawings/register/ImpactBoardPanel,rfis/RFIFormModal}.*, docs/action-plan/** | withProjectId + toUserErrorMessage on CSV import + review/impact creates + RFIFormModal fallback. |
