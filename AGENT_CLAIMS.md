...
|---|---|---|---|---|
| 2026-09-13T02:48:00Z | fix-sov-item-creation | SOV atomic creation | src/api/client/entities.ts; src/api/client/__tests__/entities.test.ts | Route SOV inserts through create_sov_item RPC so line numbers are minted atomically. |
