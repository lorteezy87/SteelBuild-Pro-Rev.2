...
|---|---|---|---|---|
| 2026-07-27T18:40:00Z | cursor-piece-wp-auto-assign-d3a1 | Piece↔WP auto-assign by sequence/area | src/lib/pieceControl/wpAutoAssign.ts, src/lib/pieceControl/__tests__/wpAutoAssign.test.ts, src/lib/pieceControl/relationshipsRepository.ts, src/lib/pieceControl/readiness.ts, src/lib/pieceControl/repository.ts, src/components/pieceControl/PieceRelationshipManager.tsx, src/components/pieceControl/__tests__/PieceRelationshipManager.test.tsx | Dry-run auto-assign pieces to WPs by sequence/area; apply via existing assign RPC. |
