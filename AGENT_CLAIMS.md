...
|---|---|---|---|---|
| 2026-07-27T03:24:00Z | task11-longtail-hex-0b3b | Task 11 long-tail dual-theme hex burn-down | src/pages/**, src/components/**, docs/superpowers/specs/2026-07-27-dual-theme-hex-allowlist.md, .superpowers/sdd/task-11-report.md | Inventory remaining page/component hex, tokenize chrome offenders, document intentional allowlist, verify grep/test/build gates. |
