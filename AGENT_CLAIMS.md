...
|---|---|---|---|---|
| 2026-09-21 | codex-restore-titleblock-action | Drawing module titleblock entry point | DrawingRegisterWorkbench/Panel, drawingRegisterTable, DrawingRegisterGridPanel and related interaction tests | Restore the existing Mark Titleblock action lost when the standalone drawing editor moved into the hub. |
