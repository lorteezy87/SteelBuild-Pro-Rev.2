...
|---|---|---|---|---|
| 2026-07-27T02:53:00Z | cursor-task-7-review-fixes | Important Task 7 review fixes | src/styles/tokens.css, src/styles/steelbuild-light.css, src/components/schedule/ScheduleGantt.jsx, src/components/schedule/scheduleGanttBars.jsx, src/components/rivet/rivetBriefStyles.js, .superpowers/sdd/task-7-report.md | Add light Gantt token counterparts and replace dark-only schedule/rivet color-mix chrome. |
| 2026-07-27T01:40:00Z | cursor-dual-theme-dark-0b3b | Dual-theme dark completion (Phase 4) — design + plan | docs/superpowers/specs/2026-07-27-dual-theme-dark-completion-design.md, docs/superpowers/plans/2026-07-27-dual-theme-dark-completion.md, src/components/shared/ThemeContext.jsx, src/boot/LayoutRoute.jsx, src/styles/command.css, src/styles/tokens.css, src/styles/steelbuild-dark.css, src/styles/base.css, src/pages/dashboard/dashboardTheme.css, AGENT_CLAIMS.md, CLAUDE.md, AGENTS.md | Spec + implementation plan for dual theme: system-pref default, command dark mapped to SteelBuild Dark, full-app hex burn-down. Coordinate before editing claimed theme foundation files. |
