...
|---|---|---|---|---|
| 2026-09-12T22:34:42Z | photo-gallery-decomposition | Photo gallery typed decomposition | src/components/photos/PhotoGallery.jsx; src/components/photos/PhotoGallery*.{ts,tsx}; src/components/photos/__tests__/** | Extract typed pure gallery derivations and isolate lightbox/edit interactions without behavior changes. |
