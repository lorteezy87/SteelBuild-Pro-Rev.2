...
|---|---|---|---|---|
| 2026-07-26T02:50:00Z | cursor-ap-loading-toasts-d3a1 | Action-plan ID 18/48 loading + toasts | src/pages/{Warranty,ChangeRequests,ProjectCloseout,Punchlist,QualityControl}.jsx, docs/action-plan/** | Loading/empty/error states on thin CRUD pages; toUserErrorMessage on their mutations. |
