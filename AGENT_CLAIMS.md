...
|---|---|---|---|---|
| 2026-07-23T04:56:18Z | codex-authenticated-staging-smoke | Authenticated staging smoke reliability | e2e/smoke.spec.ts, e2e/README.md, docs/runbooks/staging-e2e-automation.md, docs/runbooks/staging-smoke-test.md | Add read-only sign-out and unauthenticated protected-route smoke evidence; keep production and project data untouched. |
