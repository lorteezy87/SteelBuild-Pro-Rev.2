...
|---|---|---|---|---|
| 2026-07-26T03:10:00Z | cursor-ap-commercial-toasts-d3a1 | Action-plan ID 48/50 commercial + inbox toast/create | src/pages/{Backcharges,PayApplications,EmailInbox,Documents,SOV}.{jsx,tsx}, docs/action-plan/** | withProjectId/assertProjectId on Backcharges/PayApps creates; toUserErrorMessage on commercial/inbox/Documents residual toasts. |
