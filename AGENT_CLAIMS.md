...
|---|---|---|---|---|
| 2026-07-26T01:35:00Z | cursor-rfi-title-ribbon-3d17 | RFI register title ribbon clash | src/pages/rfis/RFIs.css, src/pages/rfis/RfiTable.jsx, src/pages/rfis/RfiControlCenter.tsx | Fix column-header ribbon overlapping first RFI row (sticky top mismatch). |
