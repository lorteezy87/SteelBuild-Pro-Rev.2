...
|---|---|---|---|---|
| 2026-07-27T23:20:00Z | cursor-piece-link-drawing-sets-d3a1 | Piece links to drawing sets (not sheets) | src/lib/pieceControl/{relationshipsRepository,readiness,importDrawingLink,bulkLinkDrawings}.ts, src/components/pieceControl/PieceRelationshipManager.tsx, supabase/migrations/*piece_drawing_sets* | Store/link pieces to drawing_sets; fab gate expands set→sheets |
