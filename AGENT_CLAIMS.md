...
|---|---|---|---|---|
| 2026-07-27T02:35:00Z | cursor-fix-piece-relationships-2696 | Piece relationships load failure | src/lib/pieceControl/relationshipsRepository.ts, src/lib/pieceControl/errorPresentation.ts, src/components/pieceControl/PieceRelationshipManager.tsx | Soft-fail optional snapshot tables; surface real PostgREST errors |
