...
|---|---|---|---|---|
| 2026-09-22 | codex-native-auth-navigation | Native auth and navigation | src/boot/**; src/pages/NativeSignIn.tsx; src/pages/__tests__/NativeSignIn.test.tsx; src/lib/native/**; src/lib/AuthContext.tsx; docs/app-store/READINESS.md | Implement approved sign-in/reset and trusted links/Android Back. |
