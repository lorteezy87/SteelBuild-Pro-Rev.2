...
|---|---|---|---|---|
| 2026-07-26T03:30:00Z | cursor-ap-dms-scoping-d3a1 | Action-plan ID 50/48 DMS create+toast | src/components/dms/{UploadModal,DocumentEditModal,LinkedFolderBrowser,DocumentDetailPanel}.jsx, docs/action-plan/** | withProjectId on Document creates; toUserErrorMessage on DMS modal/detail toasts. Avoiding DocumentStorageSettings (stale claim). |
