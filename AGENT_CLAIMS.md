...
|---|---|---|---|---|
| ~~2026-07-28T05:00:00Z~~ released | cursor-model-color-refresh-0b3b | 3D model color refresh after piece updates | src/components/pieceControl/PieceProductionControl.tsx, PieceLogisticsControl.tsx, CanonicalFabReleasePanel.tsx, src/hooks/useCanonicalReportingRealtime.ts | Invalidate model-elements + canonical-pieces-3d when production/logistics/release change lifecycle. |
