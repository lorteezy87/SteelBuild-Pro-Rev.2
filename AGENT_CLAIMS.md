...
|---|---|---|---|---|
| 2026-09-12T21:23:00Z | copilot-security-audit-phase-1 | PR #349 integration after #357/#360 | AGENT_CLAIMS.md; README.md; CLAUDE.md; src/pages/__tests__/DesktopConnect.test.tsx; supabase/migrations/__tests__/problemTrackerSecurityHardening.test.js | Merge latest main, preserve the focused security-hardening regression fixes, and resolve only integration conflicts. |
| 2026-09-12T21:24:00Z | copilot-rfi-form-decomposition | RFI form decomposition | src/components/rfis/RFIFormModal.jsx; src/components/rfis/rfiForm*.ts(x); src/components/rfis/__tests__/rfiForm*.test.ts(x) | Extract typed pure form derivations and a cohesive attachment interaction hook with characterization tests. |
