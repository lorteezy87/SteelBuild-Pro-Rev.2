...
|---|---|---|---|---|
| 2026-09-12T21:23:00Z | copilot-supabase-restamp-equivalence | Shared Supabase restamp equivalence | supabase/production-ownership-manifest.json; docs/runbooks/supabase-production-ownership.md; scripts/__tests__/supabaseDrift.test.mjs | Reclassify two evidence-backed equivalent restamps while keeping superseded/reset and source-absent migrations fail-closed. |
