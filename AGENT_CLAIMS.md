...
|---|---|---|---|---|
| 2026-09-12T20:42:00Z | project-metrics-typing | Dashboard project metrics TypeScript conversion | src/pages/dashboard/projectMetrics.{js,ts}; directly related tests; minimal importer type adjustments | Convert deterministic dashboard metric rules to explicit TypeScript domain inputs/outputs without changing formulas or public behavior. |
