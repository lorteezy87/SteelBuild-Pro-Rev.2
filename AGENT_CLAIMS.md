...
|---|---|---|---|---|
| 2026-09-12T22:34:44Z | production-notes-decomposition | Production Notes typed decomposition | src/pages/ProductionNotes.jsx; src/pages/__tests__/ProductionNotes*; src/lib/noteFolders/**; src/components/productionnotes/** | Extract typed note/folder/job-link view models and a cohesive interaction subsystem without changing behavior. |
