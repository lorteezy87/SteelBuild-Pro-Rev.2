...
|---|---|---|---|---|
| 2026-07-27T02:58:00Z | task-8-dms-docs-burndown | DMS / Documents theme tokenization | src/components/dms/**, src/pages/documents/**, src/pages/Documents.jsx, .superpowers/sdd/task-8-report.md | Burn down hardcoded DMS/Documents chrome colors with theme/--cmd-* tokens, lint, report, release. |
