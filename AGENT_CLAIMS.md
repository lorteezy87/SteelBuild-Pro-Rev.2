...
|---|---|---|---|---|
| 2026-07-27T05:21:38Z | cursor-enterprise-tier1-0569 | Enterprise Tier 1 readiness gaps | supabase/migrations/*pm_floor*, vercel.json, .github/workflows/ci.yml, scripts/*drift*, scripts/delete-deprecated-edge-functions*, src/pages/Landing.jsx, supabase/functions/stripe-billing/**, docs/runbooks/{owner-checklist,TECH_DEBT sync}, TECH_DEBT.md | PM-floor RLS, signup clickwrap, Stripe Tax hooks, CI drift jobs, vercel main auto-deploy off, dead-fn delete script, Tier-1 status docs |
