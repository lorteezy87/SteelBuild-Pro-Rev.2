...
|---|---|---|---|---|
| 2026-09-12T23:14:00Z | refactor-project-members | Project member administration decomposition | src/pages/ProjectMembers.jsx; src/pages/projectMembers/**; src/lib/projectMembers.*; src/__tests__/**/ProjectMembers*; src/lib/__tests__/projectMembers* | Extract typed member/role/activity derivations and cohesive query/mutation editor subsystem without changing project/org access semantics or UX. |
