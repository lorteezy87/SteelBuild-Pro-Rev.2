...
|---|---|---|---|---|
| 2026-09-12T22:44:40Z | copilot-ifc-viewer-decomposition | IFC viewer cohesive seam extraction | src/components/viewer3d/IfcModelViewer.jsx; src/components/viewer3d/ifcViewer*.ts; src/components/viewer3d/useIfcViewer*.ts; src/components/viewer3d/__tests__/ifcViewer*.test.ts | Extract typed pure derivations, lifecycle/resource cleanup helpers, and at most one safe interaction hook without changing viewer behavior. |
