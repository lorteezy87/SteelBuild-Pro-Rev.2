...
|---|---|---|---|---|
| 2026-08-08T22:05:09Z | codex-settings-personalization | Settings personalization | src/pages/Settings.jsx, src/pages/settings/**, src/components/settings/**, src/hooks/useUserPrefs.js, src/lib/userPreferences/**, src/components/nav/**, src/utils/**format**, docs/superpowers/{specs,plans}/** | Activate existing preferences and add personal navigation, projects, presets, reset/export controls. |
