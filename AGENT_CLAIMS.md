...
|---|---|---|---|---|
| 2026-09-22T10:40:00Z | codex-storage-link-stale-url | Scope attachment link state | src/components/scope/ScopeAttachmentLink.tsx; src/components/scope/__tests__/ScopeItemList.attachments.test.tsx; src/hooks/useResolvedFileUrl.js; src/hooks/__tests__/useResolvedFileUrl.test.tsx | Prevent an attachment replacement from retaining a stale signed URL while the replacement path resolves or fails. |
