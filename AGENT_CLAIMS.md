...
| 2026-07-06T00:00:00Z | schedule-summary-rollup | Schedule: summary-task date rollup + app-wide overdue exclusion | src/components/schedule/BulkAddTaskModal.jsx · src/components/schedule/scheduleGanttHelpers.js · src/components/schedule/ScheduleGantt.jsx · src/components/schedule/TaskDetailDrawer.jsx · supabase/migrations/20260706*_schedule_summary_rollup.sql · src/pages/dashboard/sections/ScheduleTimelineSection.jsx · src/pages/dashboard/sections/TeamWorkflowSection.jsx · src/pages/dashboard/projectMetrics.js · src/utils/projectKpis.js · src/lib/field/fieldToday.js · src/services/marginRiskEngine.ts · src/lib/commandCenter/*.js · src/pages/reports/*.jsx · src/pages/LookAheadSchedule.jsx · src/components/dashboard/portfolioTimeline.jsx | WS1 widen BulkAddTask modal (2px radii); WS2 AFTER trigger maintains is_summary + rolls parent dates; WS3 canonical isSummaryTask predicate excludes parents from overdue/hit-lists app-wide. |
