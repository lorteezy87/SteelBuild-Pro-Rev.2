...
|---|---|---|---|---|
| 2026-09-12T23:14:52Z | refactor-photo-upload-modal | Photo upload modal decomposition | src/components/photos/PhotoUploadModal.jsx; src/components/photos/PhotoUpload*.{ts,tsx}; src/components/photos/__tests__/PhotoUpload*.test.{ts,tsx} | Extract typed upload validation, derivation, preview lifecycle, orchestration, and cohesive UI without changing upload behavior or modal UX. |
