...
|---|---|---|---|---|
| 2026-07-26T02:25:00Z | cursor-ap-next-slice-d3a1 | Action-plan mutation adoption cont. | src/lib/mutations/**, src/pages/Submittals.tsx, src/pages/submittals/**, src/pages/Procurement.tsx, src/pages/{Documents,ChangeOrders,SOV,ContractManagement,RFIs}.jsx, docs/action-plan/** | Extend withProjectId + toUserErrorMessage; Submittals mutation helper extract; tracker 48/50/52/21. |
