...
|---|---|---|---|---|
| 2026-07-27T02:16:00Z | task6-drawings-burndown | Drawings / detailing / DrawingViewer theme token burn-down | src/components/drawings/**, src/pages/drawingViewer/**, src/pages/drawingSubmittalHub/**, src/components/design-system/tokens.js, .superpowers/sdd/task-6-report.md | Tokenize UI chrome hardcoded surface/text/border colors per Task 6 while preserving PDF/canvas ink and semantic data colors. |
