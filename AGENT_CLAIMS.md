...
|---|---|---|---|---|
| 2026-07-27T03:05:00Z | cursor-fix-piece-relationships-2696 | Piece relationships prod PGRST205 | src/lib/pieceControl/relationshipsRepository.ts, src/pages/Submittals.tsx, src/lib/query-client.ts, src/api/client/errors.ts | Soft-fail missing dispositions; normalize PostgREST errors; stop false load toasts |
