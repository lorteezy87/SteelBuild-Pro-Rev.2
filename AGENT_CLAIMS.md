...
|---|---|---|---|---|
| 2026-09-12T22:13:00Z | refactor-field-page-decomposition | Field operations route decomposition | src/pages/Field.jsx; src/pages/field/**; src/pages/__tests__/Field*.{test,spec}.{js,jsx,ts,tsx} | Extract typed dashboard derivations, route actions, and presentational sections with characterization coverage while preserving field/offline contracts. |
