...
|---|---|---|---|---|
| 2026-09-23T14:17:54Z | codex-mob4-audit-waiver | Dependency audit gate cleanup | scripts/audit-gate.mjs; scripts/__tests__/auditGate.test.mjs | Remove the two React Router waivers made stale by the 7.18.4 security upgrade so PR #476 can pass CI. |
