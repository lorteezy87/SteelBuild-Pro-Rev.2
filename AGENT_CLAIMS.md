...
|---|---|---|---|---|
| 2026-09-22T07:20:00Z | codex-storage-link-tsx | Scope attachment CI repair | src/components/scope/ScopeAttachmentLink.{jsx,tsx}; src/components/scope/__tests__/ScopeItemList.attachments.{jsx,tsx} | Convert new attachment resolver and regression test to TSX so the repository's no-new-JavaScript gate passes without changing behavior. |
