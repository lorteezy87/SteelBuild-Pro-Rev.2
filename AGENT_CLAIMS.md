...
|---|---|---|---|---|
| 2026-09-12T22:13:00Z | integrations-page-decomposition | Integrations route decomposition | src/pages/Integrations.jsx; src/pages/integrations/**; src/pages/__tests__/Integrations.test.tsx | Extract typed catalog/status/configuration derivations and a self-contained settings workflow while preserving connector semantics and exact UX. |
