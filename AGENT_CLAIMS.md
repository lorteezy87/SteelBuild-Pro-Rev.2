...
|---|---|---|---|---|
| 2026-09-12T22:13:04Z | contract-management-decomposition | Contract Management decomposition | src/pages/ContractManagement.jsx; src/pages/contractManagement/** | Extract typed derivations, payload helpers, focused hooks/components, and characterization tests without changing contract formulas or UX. |
