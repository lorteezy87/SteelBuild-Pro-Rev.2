...
|---|---|---|---|---|
| 2026-07-26T17:50:00Z | cursor-ap-budget-field-d3a1 | BudgetHours + FieldPlan loading gates | src/pages/BudgetHours.jsx, src/pages/FieldPlan.jsx | Page-shell LoadingSkeleton + error/retry; BudgetHours preset toast helper (IDs 18/48). |
