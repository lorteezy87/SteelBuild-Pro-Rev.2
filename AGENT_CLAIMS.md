...
|---|---|---|---|---|
| 2026-09-12T20:42:00Z | copilot-submittal-detail-decomposition | Submittal detail decomposition | src/pages/submittals/SubmittalDetail.tsx; src/pages/submittals/submittalDetail*.{ts,tsx}; src/pages/submittals/__tests__/submittalDetail*.test.tsx | Extract typed derived view-model and cohesive display/editor sections while preserving workflow and linked-RFI behavior. |
