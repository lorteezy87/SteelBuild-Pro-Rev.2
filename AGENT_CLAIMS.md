...
|---|---|---|---|---|
| 2026-07-26T02:30:00Z | cursor-ap-next-slice-d3a1 | Action-plan RFIs + ops mutation adoption | src/pages/RFIs.jsx, src/pages/rfis/**, src/pages/{ActionItems,DailyLogs,Constraints,LookAheadSchedule,WorkPackages}*, src/pages/drawingSubmittalHub/EscalateModal.tsx, src/pages/emailInbox/modals.tsx, docs/action-plan/** | RFI mutation helpers (ID 23); withProjectId on ops/commercial creates; tracker notes. |
