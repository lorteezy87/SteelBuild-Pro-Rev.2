...
|---|---|---|---|---|
| 2026-09-12T23:00:00Z | refactor-submittals-route | Submittals route decomposition | src/pages/Submittals.tsx; src/pages/submittals/submittalPage*.ts(x); src/pages/submittals/__tests__/submittalPage*.test.ts(x) | Extract typed route queries/view-model, route state/controllers, and coherent presentational composition without changing workflow behavior or SubmittalDetail internals. |
