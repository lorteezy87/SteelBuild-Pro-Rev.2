...
|---|---|---|---|---|
| 2026-09-12T22:44:00Z | copilot-annotation-layer-decomposition | Drawing viewer annotation layer decomposition | src/components/drawings/viewer/AnnotationLayer.jsx; src/components/drawings/viewer/annotation*.ts; src/components/drawings/viewer/*Annotation*.tsx; src/components/drawings/viewer/useAnnotation*.ts; src/components/drawings/viewer/__tests__/annotation*.test.ts | Extract typed pure annotation view-model derivations and interaction state without changing markup schema, measurement behavior, transforms, hit targets, persistence, accessibility, or render order. |
