...
|---|---|---|---|---|
| 2026-09-23T00:31:50Z | codex-mac-store-release | Mobile store release recovery | `android/**`; `ios/**`; `mobile/**`; `src/lib/native/**`; native auth/route/link handling and related tests; `package*.json`; store runbooks | Recover the unpushed Windows mobile work on current main, generate the iOS project on Mac, verify a signed test build, and prepare TestFlight upload. |
