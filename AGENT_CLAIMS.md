...
|---|---|---|---|---|
| 2026-09-21 | codex-record-sheets-api-retirement | Approved production function retirement | supabase/production-ownership-manifest.json, docs/runbooks/supabase-production-ownership.md | Record owner-confirmed sheets-api retirement and unblock the approved titleblock release (#462). |
