...
|---|---|---|---|---|
| 2026-09-12T21:24:00Z | drawings-table-decomposition | Drawings list table decomposition | src/components/drawings/DrawingsTable.jsx; src/components/drawings/drawingsTable*.{ts,tsx}; src/components/drawings/__tests__/drawingsTable*.test.{ts,tsx} | Extract typed row/view-model derivation, table selection interactions, and presentational seams without changing drawing workflow behavior or styles. |
