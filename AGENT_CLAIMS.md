...
|---|---|---|---|---|
| 2026-07-26T20:20:00Z | cursor-drawing-bulk-stage-3d17 | Drawings bulk stage + linked sets | src/components/drawings/drawingsUtils.js, src/pages/Drawings.jsx, src/components/drawings/__tests__/drawingsUtils.test.js | Unblock sheet-stage sync when linked submittals are closed; actionable toast when open. |
