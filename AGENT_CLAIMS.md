...
|---|---|---|---|---|
| 2026-07-27T04:05:00Z | cursor-fix-link-model-elements-rpc-2696 | Missing link_model_elements_to_pieces RPC | src/lib/pieceControl/modelElementLink.ts, src/lib/postgrestErrors.ts, src/lib/pieceControl/errorPresentation.ts | Client fallback when RPC missing from schema cache; clearer migration toast |
