...
|---|---|---|---|---|
| 2026-09-12T20:51:46Z | copilot-pdf-extractor-typing | PDF sheet extractor typed parser boundary | src/lib/pdfSheetExtractor.ts; src/lib/__tests__/pdfSheetExtractor.test.*; extractor importer/type-only adjustments as required | Convert the PDF sheet extractor to TypeScript with runtime-narrowed external data while preserving parsing behavior and exports. |
