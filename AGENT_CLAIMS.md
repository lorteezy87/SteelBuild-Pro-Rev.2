...
|---|---|---|---|---|
| 2026-09-12T20:13:25Z | drawing-register-performance | Drawing Register large-project performance | src/components/drawings/register/**; src/pages/drawingSubmittalHub/{DrawingRegisterPanel.tsx,drawingRegisterTable.tsx}; directly related tests | Pre-index register joins and virtualize or safely bound canonical register rows without changing workflow behavior. |
