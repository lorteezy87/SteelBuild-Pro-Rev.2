...
| 2026-08-05T16:50:00Z | grok-page-thin-a805 | Large-page thinning train (PR #245) | src/pages/**/*PageHelpers.ts, src/pages/**/*.derive.ts, src/pages/legal/**, src/pages/{Activity,BudgetHours,RiskHub,Dashboard,Billing,Warranty,Vendors,UsersManagement,Submittals,ActionItems,DrawingViewer,RFIs,FieldHub,Settings,Landing,Field,Backcharges,JobStatusReport,ProductionNotes,Deliveries,PayApplications,ProjectCloseout,RegularCalculator,OrgMembers,Documents,CostHub,ResourceScheduling,Schedule,FeetInchesCalculator,LookAheadSchedule,WorkPackages,Contacts,AlertsCenter}.* , src/pages/{activity,budgetHours,executiveView,featureFlags,alertsCenter,dashboard,warranty,vendors,usersManagement,hubs,riskHub,tutorial,documents,desktopConnect,mfa,landing,fieldHub,reports,settings,changeRequests,regularCalculator,cranePickCalculator,field,backcharges,jobStatusReport,productionNotes,deliveries,payApplications,projectCloseout,orgMembers,costHub,resourceScheduling,schedule,feetInchesCalculator,lookAheadSchedule,workPackages,contacts,legal,billing,productionStatus}/** | Behavior-preserving pure helper + presentational extracts across medium/large pages; no product features. |
