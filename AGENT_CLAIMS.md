...
|---|---|---|---|---|
| ~~2026-07-28T03:43:00Z~~ released | cursor-dark-dropdown-piece-0b3b | Dark-theme dropdown / Piece Register opacity | src/styles/{base,command,steelbuild-dark,piece-control-command,tokens}.css, src/pages/dashboard/dashboardTheme.css, src/components/nav/{ProjectPillDropdown,BellDropdown}.jsx, src/components/ui/{select,dropdown-menu}.jsx, src/pages/PieceRegister.tsx (archive dialog classes only), src/components/pieceControl/CanonicalFabReleasePanel.tsx | Opaque dark menus/selects (project pill + native option hover) and Piece Register solid command surfaces. — shipped in PR #178 |
