...
|---|---|---|---|---|
| 2026-09-12T20:20:00Z | piece-control-type-cleanup | Piece Control production derive typing | src/components/pieceControl/__tests__/pieceProductionControl.derive.test.ts | Contextually type the production snapshot fixture to clear 11 noImplicitAny errors without runtime changes. |
