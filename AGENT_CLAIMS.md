...
|---|---|---|---|---|
| 2026-07-24T06:55:00Z | cursor-drawing-fab-d3a1 | Drawing / submittal / fab-release controls | src/lib/drawingUploadUtils.js, src/lib/submittalTransitions.ts, src/lib/fabRelease/**, src/lib/fabReleaseGate.js, src/hooks/useSubmittals.ts, src/components/drawings/RevisionUploadModal.jsx, src/components/drawings/ExportFabReleaseModal.jsx, supabase/migrations/20260724120000_*.sql, related tests | Exact sheet match + ambiguous reject; submittal transition + fab-gate parity; current/superseded fab blockers. |
