...
|---|---|---|---|---|
| 2026-09-12T21:24:00Z | copilot-model-3d-tab-decomposition | Model 3D tab decomposition | src/components/viewer3d/Model3DTab.jsx; src/components/viewer3d/model3dTab*.ts; src/components/viewer3d/__tests__/model3dTab*.test.ts | Extract typed pure derivations/view models and behavior-preserving state hooks while retaining lazy/paged roster and canonical piece semantics. |
