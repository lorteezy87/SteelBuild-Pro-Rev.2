...
| 2026-08-05T16:30:00Z | grok-page-thin-a805 | Large-page thinning train (PR #245) | src/pages/**/*PageHelpers.ts, src/pages/**/*.derive.ts, src/pages/{Activity,BudgetHours,RiskHub,Dashboard,Warranty,Vendors,UsersManagement,Submittals,ActionItems,DrawingViewer,RFIs,FieldHub,Settings,Landing}.* , src/pages/{activity,budgetHours,executiveView,featureFlags,alertsCenter,dashboard,warranty,vendors,usersManagement,hubs,riskHub,tutorial,documents,desktopConnect,mfa,landing,fieldHub,reports,settings,changeRequests,regularCalculator,cranePickCalculator}/** | Behavior-preserving pure helper extracts across medium/large pages; no product features. |
