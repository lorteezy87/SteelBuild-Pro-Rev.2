...
|---|---|---|---|---|
| 2026-07-26T02:59:00Z | cursor-ap-modal-scoping-d3a1 | Action-plan ID 50/48 modal create scoping + toasts | src/components/{actionitems,scope,deliveries,photos,risks,resources,productionnotes}/**, src/pages/{Expenses,ProductionNotes}.jsx, docs/action-plan/** | withProjectId + toUserErrorMessage on project-scoped form modals; toast hygiene on Expenses/PhotoGallery. |
