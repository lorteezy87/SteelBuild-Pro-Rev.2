...
|---|---|---|---|---|
| 2026-07-27T03:06:00Z | cursor-task9-submittal-rfi-0b3b | Task 9 Submittals/RFIs residual panels & modals | src/components/submittals/**, src/components/rfis/**, src/pages/submittals/**, src/pages/rfis/**, .superpowers/sdd/task-9-report.md | Tokenize residual modal/panel chrome hex and rgb values to theme/command tokens without changing command kit primitives. |
