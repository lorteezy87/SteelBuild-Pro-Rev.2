...
|---|---|---|---|---|
| 2026-07-27T04:29:28Z | cursor-eng-quality-tier3-0569 | Eng quality Tier 3 (error surfacing, types, mega-component thinning) | src/lib/query-client.ts, src/lib/__tests__/query-client*, supabase/functions/_shared/reportError.ts, supabase/functions/{llm-proxy,email-ingest,email-send,stripe-billing,project-export}/**, src/types/supabase.ts, src/components/schedule/{TaskDetailDrawer.jsx,ScheduleGantt.jsx,taskDetail*,scheduleGanttHelpers.*}, src/pages/reports/{PortfolioOverview.jsx,portfolioOverview*}, src/pages/submittals/{components.tsx,SubmittalDetail*} | MutationCache Sentry+toast, edge reportError, patch org/billing types, extract mega-component slices (skip PieceRegister — claimed), TS helper conversion |
