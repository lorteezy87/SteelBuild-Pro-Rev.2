...
|---|---|---|---|---|
| 2026-07-26T23:35:00Z | cursor-workflow-audit-2696 | Workflow audit + mutation lifecycle repairs | docs/audits/WORKFLOW_AUDIT_2026-07-26.md, src/components/shared/DeleteDialog.jsx, src/api/client/functions.ts, src/pages/RFIs.jsx, src/pages/Schedule.tsx | Full workflow viability audit; fail-closed delete/LLM/agentMemory; keep modal open until mutateAsync settles |
