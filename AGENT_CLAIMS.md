...
|---|---|---|---|---|
| 2026-07-28T03:55:00Z | cursor-bulk-production-0b3b | Bulk production station advance | supabase/migrations/20260728040000_advance_piece_stations_bulk.sql, src/lib/pieceControl/productionRepository.ts, src/lib/pieceControl/bulkStationAdvance.ts, src/components/pieceControl/PieceProductionControl.tsx, src/styles/piece-control-command.css | Set-based advance_piece_stations RPC + multi-select Complete next/station on Production board. |
