...
|---|---|---|---|---|
| 2026-09-21 | codex-email-ingest-build-guard | Email ingest build repair and Edge CI coverage | supabase/functions/email-ingest/index.ts, .github/workflows/ci.yml and related release documentation | Repair malformed authorization header and typecheck all owned entrypoints. Titleblock PR #462 merged; production verification pending. |
