...
|---|---|---|---|---|
| 2026-07-25T23:19:00Z | cursor-package-board-3d17 | Package Board (Piece Register) | docs/superpowers/specs/2026-07-25-package-board-design.md, src/components/pieceControl/PackageBoard*.tsx, src/pages/PieceRegister.tsx | WP-column board view on glue; Lifecycle/3D modes later.
