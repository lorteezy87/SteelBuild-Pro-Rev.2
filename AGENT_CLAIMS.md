...
|---|---|---|---|---|
| 2026-07-28T03:43:00Z | cursor-dark-dropdown-piece-0b3b | Dark-theme dropdown / Piece Register opacity | src/styles/base.css, src/styles/command.css, src/styles/steelbuild-dark.css, src/styles/piece-control-command.css, src/pages/dashboard/dashboardTheme.css, src/components/nav/ProjectPillDropdown.jsx | Opaque dark menus/selects (project pill + native option hover) and Piece Register solid command surfaces. |
