...
|---|---|---|---|---|
| 2026-07-26T20:30:00Z | cursor-dcc-event-glue-3d17 | Detailing CC event-glue design | docs/superpowers/specs/2026-07-26-detailing-cc-event-glue-design.md, docs/architecture/drawing-workflow-dual-source.md, docs/detailing-control-center-design.md | Spec only: create/link prefill, revision attach confirm, status→stage hard sync + BIC/dates suggest strip. |
