...
|---|---|---|---|---|
| 2026-07-26T02:40:00Z | cursor-ap-next-slice-d3a1 | Action-plan Drawings helpers + remaining creates | src/pages/Drawings.jsx, src/pages/drawings/**, src/pages/{FabRelease,ContractManagement,Deliveries,ProductionNotes}*, src/pages/Schedule.tsx, src/pages/Submittals.tsx, docs/action-plan/** | Drawing mutation helpers (ID 27); withProjectId on remaining creates; tracker. |
