...
|---|---|---|---|---|
| 2026-07-25T20:25:00Z | cursor-remove-autolock-3d17 | Remove drawing-set auto-lock | src/hooks/useSubmittals.ts, src/hooks/__tests__/useSubmittals.test.ts, src/pages/Submittals.tsx, src/components/drawings/SetApprovalModal.jsx | Stop auto-locking drawing sets on terminal submittal approval. |
