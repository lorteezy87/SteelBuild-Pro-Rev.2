...
|---|---|---|---|---|
| 2026-07-27T02:37:00Z | task-7-gantt-burndown | Schedule / Gantt burn-down | src/components/schedule/**, src/components/gantt/**, src/lib/ganttTheme.js, /workspace/.superpowers/sdd/task-7-report.md | Replace schedule/Gantt chrome hardcoded colors with `--sbd-gantt-*` vars while leaving categorical phase encodings allowlisted. |
