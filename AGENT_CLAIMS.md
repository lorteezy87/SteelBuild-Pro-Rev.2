...
|---|---|---|---|---|
| 2026-07-26T20:30:00Z | cursor-dcc-event-glue-3d17 | Detailing CC event-glue impl | docs/superpowers/specs/2026-07-26-detailing-cc-event-glue-design.md, docs/superpowers/plans/2026-07-26-detailing-cc-event-glue.md, src/lib/submittalLinkGlue.ts, src/pages/Submittals.tsx, src/pages/submittals/SubmittalFormModal.tsx, src/pages/submittals/StatusSuggestStrip.tsx, src/components/submittals/AttachRevisionToSubmittalModal.tsx, src/pages/Drawings.jsx, src/pages/drawingSubmittalHub/**, src/components/drawings/RevisionUploadModal.jsx | Implement event glue: prefill, attach confirm, status suggest strip, unlinked hint. |
