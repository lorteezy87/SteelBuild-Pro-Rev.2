...
|---|---|---|---|---|
| 2026-09-13T08:47:00Z | fix-expense-creation | Expense atomic creation | src/api/client/entities.ts; src/pages/Expenses.jsx; src/components/expenses/ExpenseImportModal.jsx; supabase/migrations/20260913084700_expense_atomic_creation.sql; related tests/types | Route expense creation through create_expense RPC so expense numbers are minted atomically. |
